...
3. When a JD is provided, save the exact JD text into the output folder before generating anything.
...
- **Output folder:** always create `Resume_[JobTitle]_[Company]/` in the output directory defined under FILE LOCATIONS. Place all 5 files inside: resume PDF, resume DOCX, cover letter PDF, cover letter DOCX, WHY.md. Never save to the skill folder or unrelated current workspace.
